...
"comment":"인식 관련 메모 1~2문장"}"""
    ...
    # 2025-11-18에 preview 모델(06-17, 05-20)이 종료되어 404가 발생 → 현재(2026-08) 유효한 모델로 교체
    GEMINI_MODELS = [
        "gemini-2.5-flash-lite",  # 1차: 가장 가볍고 빠름 (안정 버전)
        "gemini-2.5-flash",       # 2차: 표준 Flash (안정 버전)
        "gemini-3.7-flash",       # 3차: 최신 GA 모델 (폴백)
    ]
